This directory consists of examples in pytorch and tensorflow for classifying MNIST datasets. Under the directory pytorch/tensorflow, the directory ytopt incoudes all scripts

This directory includes all files for autotuning ECP app OpenMC (https://github.com/openmc-dev/openmc) with the problem size XXL using ytopt-libensemble on OLCF Crusher only. 

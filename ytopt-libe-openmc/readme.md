This directory includes all files for autotuning ECP app OpenMC with the problem size XXL using ytopt-libensemble on OLCF Crusher only. Because OpenMC code is very complex,
